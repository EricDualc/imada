...
Imada now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<imada_address\> \<monthly_payment_imada\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ IMADA, _12_ times over the course of a year totaling _24000_ IMADA.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<imada_address\> \<monthly_payment_imada\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` IMADA.
 ...
 * vote-many          - Vote on a Imada initiative
 * vote-alias         - Vote on a Imada initiative
 * vote               - Vote on a Imada initiative/budget
