...
In order to support loading of multiple wallets in imada-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is imada.cpp.
...
Changes to imada.cpp
----------------------
imada.cpp is the entry point into imada-qt, and as such, will require some minor modifications to provide hooks for
