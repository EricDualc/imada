...
This mechanism has been integrated into Bitcore-Node-IMADA which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/IMADA-Project/insight-api-imada#web-socket-api](https://github.com/IMADA-Project/insight-api-imada#web-socket-api) 
* API: [https://github.com/IMADA-Project/insight-api-imada#instantx-transactions](https://github.com/IMADA-Project/insight-api-imada#instantx-transactions)
...
By default, the Imadacore daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Imadacore daemon:
