...
RESOURCES += src/qt/imada.qrc src/qt/imada_locale.qrc

TRANSLATIONS += src/qt/locale/imada_bg.ts \
                src/qt/locale/imada_de.ts \
                src/qt/locale/imada_en.ts \
                src/qt/locale/imada_es.ts \
                src/qt/locale/imada_fi.ts \
                src/qt/locale/imada_fr.ts \
                src/qt/locale/imada_it.ts \
                src/qt/locale/imada_ja.ts \
                src/qt/locale/imada_pl.ts \
                src/qt/locale/imada_pt.ts \
                src/qt/locale/imada_ru.ts \
                src/qt/locale/imada_sk.ts \
                src/qt/locale/imada_sv.ts \
                src/qt/locale/imada_vi.ts \
                src/qt/locale/imada_zh_CN.ts
