...
from test_framework.test_framework import ImadaTestFramework, SkipTest
...
class ZMQTest (ImadaTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that imada has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("imadad has not been built with zmq enabled.")
