...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ImadaTestFramework
    pass

class ExampleTest(ImadaTestFramework):
    # Each functional test is a subclass of the ImadaTestFramework class.
    ...
    def custom_method(self):
        ...
        ImadaTestFramework class so other tests can use it."""
