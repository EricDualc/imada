#!/bin/sh
#-###############################################-#
# C++ Cross-Compiler - The Imadacore Developer-2018 #
#-###############################################-#
...
[ -f "./src/qt/imada-qt.exe" ] && cp "./src/qt/imada-qt.exe" "$RELEASE"
[ -f "./src/imadad.exe" ] && cp "./src/imadad.exe" "$RELEASE"
[ -f "./src/imada-cli.exe" ] && cp "./src/imada-cli.exe" "$RELEASE"
