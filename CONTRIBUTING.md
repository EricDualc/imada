Contributing to Imadacore
============================

The Imadacore project operates an open contributor model where anyone is
...
The following applies to code changes to the Imadacore project, and is not to be
confused with overall IMADA Network Protocol consensus changes.

Whether a pull request is merged into Imadacore rests with the project merge
...
Patches that change IMADA consensus rules are considerably more involved than
...
Where a patch set proposes to change the IMADA consensus, it must have been
...
The project leader is the release manager for each Imadacore release.
