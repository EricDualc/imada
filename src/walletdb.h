...
public:
    ...
    bool WriteImadaNodeConfig(std::string sAlias, const CImadaNodeConfig& nodeConfig);
    bool ReadImadaNodeConfig(std::string sAlias, CImadaNodeConfig& nodeConfig);
    bool EraseImadaNodeConfig(std::string sAlias);
