...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Imada features */
        {"imada", "masternode", &masternode, true, true, false},
        //{"imada", "masternodelist", &masternodelist, true, true, false},
        //{"imada", "mnbudget", &mnbudget, true, true, false},
        //{"imada", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"imada", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"imada", "mnsync", &mnsync, true, true, false},
        {"imada", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"imada", "darksend", &darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> imada-cli " + methodname + " " + args + "\n";
}
