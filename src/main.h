...
/////////////////////////////////////////// imada
#include <imada/imadastate.h>
#include <imada/imadaDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <imada/storageresults.h>
///////////////////////////////////////////

extern std::unique_ptr<ImadaState> globalState;
...
using ExtractImadaTX = std::pair<std::vector<ImadaTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
extern unsigned int dgpMaxBlockSize; // imada
...
class ImadaTxConverter{

public:

    ImadaTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransaction>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionImadaTransactions(ExtractImadaTX& imadaTx);
...
private:
    ...
    ImadaTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<ImadaTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
...
private:
    ...
    std::vector<ImadaTransaction> txs;
