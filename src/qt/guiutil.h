...
/** Utility functions used by the IMADA Qt UI.
 */
namespace GUIUtil
{
...
// Render IMADA addresses in monospace font
...
// Parse "imada:" URI into recipient object, return true on successful parsing
