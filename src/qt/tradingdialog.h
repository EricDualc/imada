...
#ifndef IMADA_TRADINGDIALOG_H
#define IMADA_TRADINGDIALOG_H
...
private slots:
    ...
    void showBalanceOfIMADAOnTradingTab();
    ...
    void showBalanceOfIMADAOnSendTab();
    void showBalanceOfIMADAOnBalanceTab();
    ...
    QString BuyIMADA(QString OrderType, double Quantity, double Rate);
    QString SellIMADA(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"IMADA/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"IMADA/BTC\"}"));// "{\"gender\":\"male\"}");
