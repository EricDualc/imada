...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(IMADA);
    unitlist.append(mIMADA);
    unitlist.append(uIMADA);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case IMADA:
        return QString("imada");
    case mIMADA:
        return QString("mimada");
    case uIMADA:
        return QString::fromUtf8("uimada");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case mIMADA:
            return QString("mIMADA");
        case uIMADA:
            return QString::fromUtf8("μIMADA");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case IMADA:
            return QString("tIMADA");
        case mIMADA:
            return QString("mtIMADA");
        case uIMADA:
            return QString::fromUtf8("μtIMADA");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case IMADA:
            return QString("IMADA");
        case mIMADA:
            return QString("Milli-IMADA (1 / 1" THIN_SP_UTF8 "000)");
        case uIMADA:
            return QString("Micro-IMADA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case IMADA:
            return QString("TestIMADAs");
        case mIMADA:
            return QString("Milli-TestIMADA (1 / 1" THIN_SP_UTF8 "000)");
        case uIMADA:
            return QString("Micro-TestIMADA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
...
int BitcoinUnits::decimals(int unit)
{
    ...
    {
    case IMADA: return 8;
    case mIMADA: return 5;
    case uIMADA: return 2;
    default: return 0;
    }
}
