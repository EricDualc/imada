...
#include "genesis/imadaMainNetwork.cpp"
#include "genesis/imadaTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::imadaMainNetwork: return c_genesisInfoImadaMainNetwork;
	case Network::imadaTestNetwork: return c_genesisInfoImadaTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::imadaMainNetwork: return c_genesisStateRootImadaMainNetwork;
	case Network::imadaTestNetwork: return c_genesisStateRootImadaTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
