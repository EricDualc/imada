...
////////////////////////////////////////////////////////////// // imada
	void setImadaSchedule(EVMSchedule _imadaSchedule) const { imadaSchedule = _imadaSchedule; }

	EVMSchedule& getImadaSchedule() const { return imadaSchedule; }
...
private:
	...
	mutable EVMSchedule imadaSchedule; // imada
