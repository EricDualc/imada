...
bool CWalletDB::WriteImadaNodeConfig(std::string sAlias, const CImadaNodeConfig& nodeConfig)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadImadaNodeConfig(std::string sAlias, CImadaNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig);
}

bool CWalletDB::EraseImadaNodeConfig(std::string sAlias)
{
    nWalletDBUpdated++;
